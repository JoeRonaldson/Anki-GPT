  ...
  const sendMessage = (user_text: string) => {
    ...
    axios
      ...
      .then((response) => {
        ...
        const csv = convertToCsv(outputArray)
        console.log(csv)
